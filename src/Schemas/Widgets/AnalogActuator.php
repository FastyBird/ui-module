 ...
 *
 * @template  T of Entities\Widgets\AnalogActuator
 * @extends   Widget<T>
 *
 * @package         FastyBird:UIModule!
 * @subpackage      Schemas
...
final class AnalogActuator extends Widget
{
	 ...
	 */
	public const SCHEMA_TYPE = MetadataTypes\Sources\Module::UI->value . '/widget/' . Entities\Widgets\AnalogActuator::TYPE;
