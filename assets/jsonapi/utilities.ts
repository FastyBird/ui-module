...
export const WIDGET_DISPLAY_DOCUMENT_REG_EXP = '^(?<source>[a-z0-9.-]+)/display/(?<type>[a-z0-9-]+)$';
export const WIDGET_DATA_SOURCE_DOCUMENT_REG_EXP = '^(?<source>[a-z0-9.-]+)/data-source/(?<type>[a-z0-9-]+)$';
